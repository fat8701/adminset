...
urlpatterns = [
    ...
    url(r'^system/(?P<ip>.+)/(?P<timing>\d+)/$', system.host_info, name='host_info'),
    url(r'^getcpu/(?P<ip>.+)/(?P<timing>\d+)/$', system.get_cpu, name='get_cpu'),
    url(r'^getmem/(?P<ip>.+)/(?P<timing>\d+)/$', system.get_mem, name='get_mem'),
    url(r'^getdisk/(?P<ip>.+)/(?P<timing>\d+)/(?P<partition>\d+)/$', system.get_disk, name='get_disk'),
    url(r'^getnet/(?P<ip>.+)/(?P<timing>\d+)/(?P<net_id>\d+)/$', system.get_net, name='get_net'),
